...
import com.example.retrofit.src.data.models.team.list.TeamNewListResponseModel
import com.example.retrofit.util.addComma

class NewAdapter(val context : Context, val list:List<TeamNewListResponseModel>):RecyclerView.Adapter<NewAdapter.Holder>() {
